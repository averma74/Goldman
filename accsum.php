...
<?php
  ...
  // $age = mysql_real_escape_string($age);
   ...
   //build query
   $query = "SELECT * FROM transaction WHERE user = '$userid' ORDER BY  time DESC limit 0,2147483647";
...
<a class="btn btn-secondary btn-lg" href="accsum.php" role="button">Refresh</a>
</body>
</html>